...
| Learning  by Asking Questions                                | read+no      | Combination of VQA+dialog                                    |
| Efficient  Optimization for Rank-based Loss Functions        | read+no      | Decomposition of loss:  average precision (AP) or the normalized discounted cumulative gain (NDCG), to accelerate BP |
| Finding  It": Weakly-Supervised Reference-Aware Visual Grounding in Instructional  Video" | read+no      | New task definition                                          |
